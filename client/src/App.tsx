...
export function App() {
  return <QueryClientProvider client={queryClient}><BrowserRouter><AuthProvider><ErrorBoundary><Routes>
    ...
    <Route element={<PublicLayout />}><Route path="/shops" element={<ShopsPage />} /><Route path="/login" element={<LoginPage />} /><Route path="/register" element={<RegisterPage />} /><Route path="/verify-email" element={<VerifyEmailPage />} /><Route path="/forgot-password" element={<ForgotPasswordPage />} /><Route path="/reset-password" element={<ResetPasswordPage />} /><Route path="/notifications" element={<ComingSoonPage />} /><Route path="/about" element={<ContentPage />} /><Route path="/contact" element={<ContentPage />} /><Route path="/how-it-works" element={<ContentPage />} /><Route path="/faqs" element={<ContentPage />} /><Route path="/offers" element={<OffersPage />} /><Route path="/support" element={<ContentPage />} /><Route path="/partner" element={<ContentPage />} /><Route path="/resources" element={<ContentPage />} /></Route>
    <Route path="/shops/:slug" element={<ShopPage />} />
    <Route element={<PublicLayout />}><Route path="/menu" element={<MenuPage />} /><Route path="/vendor/login" element={<VendorLoginPage />} /><Route path="/resources/:article" element={<ResourceArticlePage />} /></Route>
    <Route path="*" element={<NotFoundPage />} />
    <Route element={<CustomerLayout />}><Route element={<ProtectedRoute />}><Route element={<RoleRoute role="CUSTOMER" />}><Route path="/cart" element={<CartPage />} /><Route path="/checkout" element={<CheckoutPage />} /><Route path="/orders" element={<OrdersPage />} /><Route path="/orders/:id" element={<OrderDetailPage />} /><Route path="/favorites" element={<FavoritesPage />} /></Route></Route></Route>
